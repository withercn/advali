<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keyedit.aspx.cs" Inherits="AdvAli.Web.Keys.keyedit" %>
...
<body>
    ...
    <div class="start">
        ...
        <div class="content">
            <div class="count" runat="server">修改关键词</div>
            <div></div>
            <ul class="logins">
                ...
                <li>&nbsp;&nbsp;　　　　　<input type="submit" class="button" runat="server" value="修　　改" onserverclick="Keys_Click" /> <input type="button" value="返　　回" onclick="history.go(-1);" class="button" /></li>
            </ul>
