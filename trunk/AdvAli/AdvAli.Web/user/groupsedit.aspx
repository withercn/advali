<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="groupsedit.aspx.cs" Inherits="AdvAli.Web.user.groupsedit" %>
...
<body>
    ...
    <div class="start">
        ...
        <div class="content">
            <div id="Div2" class="count" runat="server">修改用户组</div>
            <div></div>
            <ul class="logins">
                ...
                <li style="clear:both;">&nbsp;&nbsp;<input type="submit" class="button" runat="server" value="修　　改" onserverclick="GroupsEdit_Click" /> <input type="button" value="返　　回" onclick="history.go(-1);" class="button" /></li>
            </ul>
