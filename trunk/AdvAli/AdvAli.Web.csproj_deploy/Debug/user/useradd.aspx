<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="useradd.aspx.cs" Inherits="AdvAli.Web.user.useradd" %>
...
<head runat="server">
    ...
    function testpwd(){var obj1 = $("password").value;var obj2 = $("repassword").value;if(obj1.length<6||obj1.length>20){$("lbpwd1").innerHTML = "密码长度为6-20个字符";return false;}else{$("lbpwd1").innerHTML = "";return true;}if($("password").value != $("repassword").value){$("lbpwd2").innerHTML = "两次输入的密码不相同！";return false;}else{$("lbpwd2").innerHTML = "";return true;}}
...
<body>
    <form id="form1" runat="server" onsubmit="return testsubmit()">
    <div class="start">
        <div class="navigation" runat="server"><%=Navigations%></div>
            <div class="content">
            <div class="count" runat="server">添加用户</div>
            <div></div>
            <ul class="logins">
                ...
                <li>&nbsp;&nbsp;　　　　　　<input type="submit" runat="server" onserverclick="UserAdd_Click" class="button" value="修改" />&nbsp;&nbsp;<input type="button" onclick="history.go(-1);" class="button" value="返回" /></li>
            </ul>
        </div>
