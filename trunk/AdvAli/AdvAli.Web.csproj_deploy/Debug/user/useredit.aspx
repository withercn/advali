<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="useredit.aspx.cs" Inherits="AdvAli.Web.user.useredit" %>
...
<body>
    ...
    <div class="start">
        ...
        <div class="content">
            <div class="count" runat="server">修改用户资料</div>
            <div></div>
            <ul class="logins">
                ...
                <li>&nbsp;&nbsp;　　　　　　<input type="submit" runat="server" onserverclick="UserEdit_Click" class="button" value="修改" />&nbsp;&nbsp;<input type="button" onclick="history.go(-1);" class="button" value="返回" /></li>
            </ul>
        </div>
